...
# setting bounds for green color (working bounds for topview1-r.jpg
# good for dark colors, causing issues when mixing
...
cv2.imwrite('out/' + filename + '_thresh_no_blur' + ext, mask)
