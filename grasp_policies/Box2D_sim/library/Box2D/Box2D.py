...
class b2Separator(object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        """__init__(self) -> b2Separator"""
        _Box2D.b2Separator_swiginit(self,_Box2D.new_b2Separator())
    def Separate(self, *args, **kwargs):
        """
        Separate(self, b2Body pBody, b2FixtureDef pFixtureDef, vector<(b2Vec2)> pVerticesVec, 
            int scale)
        """
        return _Box2D.b2Separator_Separate(self, *args, **kwargs)

    def Validate(self, *args, **kwargs):
        """Validate(self, vector<(b2Vec2)> verticesVec) -> int"""
        return _Box2D.b2Separator_Validate(self, *args, **kwargs)
