        ...
        while not done:
            for event in pygame.event.get():
               if event.type == KEYDOWN:
                    ...
                    elif event.key == Keys.K_e:
                        self.option = "end"
                        done = True
                    elif event.key == Keys.K_s:
                        self.option = "save"
                        done = True
                    elif event.key == Keys.K_r:
                        self.option = "replay"
                        done = True
                    elif event.key == Keys.K_t:
                        self.option = "retry"
                        done = True
                    ...
                    elif event.key == Keys.K_c:
                        self.option = "continue"
                        done = True

            self.screen.fill((200,200,255),(100,100,400,200))
            text = message.split("\n")
            i=0
            for line in text:
                text_rendered = self.font.render(line,60,(0,0,0))
                self.screen.blit(text_rendered,(200,150 + (22*i)))
                i+=1
