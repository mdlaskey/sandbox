...
# generate a recorder with frame width and height
...
while 1:
    ...
    cv2.imshow("segmented", mask_b)
    #rec.write(cv2.cvtColor(mask_b, cv2.COLOR_GRAY2BGR))    # uncomment to write video
    #cv2.imwrite('sample.jpg', mask_b)                      # uncomment to write image
    key = cv2.waitKey(20)
    if key == 27:
        break
